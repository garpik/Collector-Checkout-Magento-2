...
class Config
{
    ...
    {
        return $this->scopeConfig->getValue('collector_collectorcheckout/general/updatecustomer', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    ...
    {
        return floatval($this->scopeConfig->getValue('collector_collectorcheckout/invoice/invoice_fee_b2b', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
    }

    public function getInvoiceB2CFee(): float
    {
        return floatval($this->scopeConfig->getValue('collector_collectorcheckout/invoice/invoice_fee_b2c', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
    }
